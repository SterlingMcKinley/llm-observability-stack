...
1. bash randomizer to split the traffic between success and failure for model: meta-llama3-70b
...
2. bash randomizer to split the traffic between success and failure for model: broken-model
